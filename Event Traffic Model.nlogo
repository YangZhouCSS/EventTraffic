...
to setup-globals
  set num-taxis floor (percentage-taxis / 100 * num-cars)
  set avg-speed []
  set current-phase 0
...
to setup-taxi  ;;normal taxis
  ask  n-of num-taxis cars [set taxi? true set color blue]
...
1119
272
Average Speed of Cars during Last Hour
Time
wait-time
0.0
10.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot hour-avg-speed /  0.014667"
...
165
256
No more than 523 cars at the same time.
11
0.0
1
